...
| File | Role |
|------|------|
| `@collabdt/core/types/dbTypes.ts` | All domain interfaces and enums |
| `@collabdt/core/types/datasetTypes.ts` | Dataset and tile layer types |
| `@collabdt/core/types/global.ts` | Shared utility types (`Position`, etc.) |
