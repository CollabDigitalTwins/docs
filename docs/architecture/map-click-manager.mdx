...
Source: `@collabdt/core/core/components/viewers/map/utils/MapEventManager/MapClickManager.ts`
...
| File | Role |
|------|------|
| `@collabdt/core/core/components/viewers/map/utils/MapEventManager/MapClickManager.ts` | Full implementation |
| `@collabdt/core/core/components/viewers/map/src/MapLayers/src/BuildingLayers/index.tsx` | Example of register/unregister pattern |

## Related

- [Map Layers](./map-layers.mdx) — all layers that use this system
- [State Management](./state-management.mdx) — `MapProvider` holds the `MapClickManager` instance
